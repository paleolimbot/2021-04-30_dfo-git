...
If you're already good at this, see if you can modify the code below to be less repetitive! There are two plots that are essentially identical that *could* be extracted into a single function.
